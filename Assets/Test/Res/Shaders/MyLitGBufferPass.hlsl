#ifndef UNIVERSAL_My_LIT_GBUFFER_PASS_INCLUDED
#define UNIVERSAL_My_LIT_GBUFFER_PASS_INCLUDED
...
FragmentOutput LitGBufferPassFragment(Varyings input)
{
    ...
    FragmentOutput finalCol;
    finalCol = BRDFDataToGbuffer(brdfData, inputData, surfaceData.smoothness, surfaceData.emission + color);
    // finalCol.GBuffer0 = half4(0,0,0,0);
    // finalCol.GBuffer1 = half4(0,0,0,0);
    // finalCol.GBuffer2 = half4(0,0,0,0);
    // finalCol.GBuffer3 = half4(0,0,0,0);
    return finalCol;
}
